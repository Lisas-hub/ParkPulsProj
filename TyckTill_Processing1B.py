...
# >>> SENTIMENT MODEL using n_points subset <<<
...
df = pd.read_excel(f"{output_folder}/tycktill_with_lemmas.xlsx", parse_dates=["Inkommet datum"])
...
df.to_excel(f"{output_folder}/tycktill_with_sentiment.xlsx", index=False)
