...
park_keywords = ["park", "natur", "naturreservat",
                 "sandlåda", "kompisgunga", "gunga",
                 "lekplats", "lekpark", "parklek",
                 "parkgata", "parkväg", "naturstig","ridväg", "strandstig", "vandringsstig",
                 "gräsyta", "gräs", "träd", "tall", "gran", "björk", "lövträd", "busk", "stubb", "gren", "strand", "blommor", "äng", "änge", "skog", "skogsdunge", "odling",
                 "tanto", "vandispark", "kronobergspark", "kastanjepark", "judarn", "judarskog", "judarnsjö", "rålis", "rålamshov", "rålambshovspark", "humlegård"
                 ]    # *** FYLL PÅ ***
...
pts_with_topics1.to_file("data/tycktill.gpkg", layer="pts_with_park_comments_by_topic1", driver="GPKG", mode="w")
...
pts_with_topics1.to_file("data/tycktill.gpkg", layer="pts_with_park_comments_by_keyword1", driver="GPKG", mode="w")
...
pts_with_topics1.to_file("data/tycktill.gpkg", layer="pts_with_park_comments_by_topic_and_keyword1", driver="GPKG", mode="w")
...
parks_with_top5_topics.to_file("data/tycktill.gpkg", layer="parks_with_top5_topics", driver="GPKG", mode="w")
